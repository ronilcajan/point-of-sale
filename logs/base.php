...
<div class="sidebar">
	...
	<button id="sidebar_button" onclick="window.location.href='../logs/logs.php?username=<?php echo $_GET['username']; ?>'">List</button>
	<button id="sidebar_button" type="button" data-toggle="popover" title="Logs Management" data-content="Here you can view activity in the store." data-placement="bottom">Help?</button>
